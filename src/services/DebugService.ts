...
export class DebugService {
	...
	public readonly onDidChangeDebugSessions: vscode.Event<void> =
		this._onDidChangeDebugSessions.event;
	...
	private detectDebugger(): boolean {
		...
		const debuggerExt = extensions.find(
			(ext) =>
