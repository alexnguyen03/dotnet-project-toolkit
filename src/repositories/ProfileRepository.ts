...
export interface IProfileRepository {
     ...
     */
    save(projectInfo: ProjectInfo, profileName: string, content: string, overwrite?: boolean): Promise<string | null>;
...
export class ProfileRepository implements IProfileRepository {
    ...
    async save(projectInfo: ProjectInfo, profileName: string, content: string, overwrite: boolean = false): Promise<string | null> {
    ...
    getProfilePath(projectInfo: ProjectInfo, profileName: string): string {
        return path.join(projectInfo.projectDir, 'Properties', 'PublishProfiles', `${profileName}.pubxml`);
    }
}
